...
We welcome contributions to myfi! Whether you're fixing bugs, adding new features, or improving documentation, your help is appreciated. That being said, we implore all of our contributors to adhere to a standard of quality and professionalism. Please follow the guidelines below to ensure a smooth contribution process.
...
If you encounter any bugs or issues while using myfi, please report them by opening an issue on the GitHub repository. Provide as much detail as possible, including steps to reproduce the issue, expected behavior, and actual behavior.
